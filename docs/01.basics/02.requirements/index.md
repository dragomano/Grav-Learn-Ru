...
> Минимальные и рекомендуемые требования Grav CMS, права доступа, инструменты для работы.
...
Для правильной работы Grav ваш веб-сервер должен иметь соответствующие разрешения на запись журналов, кэшей и т. д. При использовании интерфейса командной строки [CLI](07.cli-console/02.grav-cli) или менеджера пакетов Grav [GPM](07.cli-console/04.grav-cli-gpm) пользователь, запускающий PHP из командной строки, также должен иметь соответствующие разрешения на изменение файлов.
...
Хотя существует много способов развертывания **Grav**, самый простой — скопировать локальный сайт на хостинг. Самый простой способ сделать это с помощью [FTP-клиента](https://ru.wikipedia.org/wiki/FTP). Перечислим наиболее популярные:
