...
> Как использовать объекты Flex в Grav CMS. Шаблоны коллекций и объектов.
...
?> **СОВЕТ:** Чтобы включить и отобразить каталог Flex, пожалуйста, прочтите **[Включение каталога](/08.advanced/01.flex/01.administration/01.introduction/index)**
...
Смотрите более подробную документацию: [Визуализация коллекции](/08.advanced/01.flex/02.using/03.collection/index?id=render) и [визуализация объекта](/08.advanced/01.flex/02.using/04.object/index?id=render).
