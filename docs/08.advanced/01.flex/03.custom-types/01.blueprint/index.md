...
> Руководство по созданию чертежей Flex в Grav CMS.
...
?> **СОВЕТ:** Мы предполагаем, что вы уже знаете, как создавать свои собственные **[формы и чертежи](/06.forms/index)**.

> **ПРЕДУПРЕЖДЕНИЕ:** Лучше не использовать простой формат списка для описания полей, как указано в секции **[Создание простой формы](/06.forms/02.forms/index?id=Создание-простой-формы)**. Также не передавайте в этот файл раздел формы `process`, он не будет использоваться Flex.
...
?> **СОВЕТ:** Эти параметры конфигурации могут быть изменены в секции **[Настройка](/08.advanced/01.flex/01.administration/03.configuration/index)** **[Администрирования Flex-каталога](/08.advanced/01.flex/01.administration/index)**.
