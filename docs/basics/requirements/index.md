...
5. [Kate](https://kate-editor.org/ru/about-kate/) - MacOS/Windows/Linux - Легкий, но мощный и универсальный текстовый редактор с открытым исходным кодом и инструмент программирования, поддерживающий подсветку для более чем 300 языков (включая Markdown).
