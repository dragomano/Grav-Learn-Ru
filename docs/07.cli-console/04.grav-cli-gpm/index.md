...
> Список доступных команд менеджера пакетов Grav GPM.
...
Настоятельно рекомендуется всегда делать резервную копию перед выполнением самостоятельного обновления (см. _Создание резервной копии_ в [разделе CLI](/07.cli-console/02.grav-cli/index)).
...
Схема может служить нескольким различным целям, включая определение вашей идентичности ресурса. Пожалуйста, обратитесь к главе [Чертежи](/06.forms/01.blueprints/index) для более подробной документации о том, что такое чертежи и как они должны быть скомпилированы.
...
Следуйте инструкциям в разделе [Процесс выпуска темы/плагина](/08.advanced/09.grav-development/index?id=Процесс-выпуска-темыплагина).
