...
> Знакомимся с командной строкой и специфическими командами Grav CMS.
...
> Эти команды более подробно описаны в документации [Grav CLI](/07.cli-console/02.grav-cli/index) и [Grav GPM](/07.cli-console/04.grav-cli-gpm/index).
