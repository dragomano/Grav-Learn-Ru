...
> Различные трюки при работе с Twig в Grav CMS.
...
Вы хотите выбрать случайный элемент из массива, переведенного на определенный язык. Для этого предполагается, что у вас есть [многоязычный сайт](/02.content/11.multi-language/index), настроенный в соответствии с документацией.
