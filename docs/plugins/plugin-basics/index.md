...
!!! tip "Совместимость с Grav 2.0"

    Если вы автор плагина, вам следует добавить новое свойство `compatibility:` в ваш файл `blueprints.yaml`, чтобы указать, с какими версиями Grav ваш плагин был протестирован. Эта информация используется системой безопасного обновления, чтобы убедиться, что все плагины готовы перед выполнением крупного обновления Grav. Подробности смотрите в документации [Совместимость плагинов](https://learn.getgrav.org/20/plugins/plugin-compatibility).
