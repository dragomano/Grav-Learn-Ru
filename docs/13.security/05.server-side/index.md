...
> О конфигурации PHP и веб-сервера при использовании Grav CMS.
...
- Используйте отдельного пользователя с ограниченными правами для выполнения PHP для Grav: [Разрешения в документах](/11.troubleshooting/05.permissions/index).
