...
> Используемые функции Twig в Grav CMS.
...
Берет корректную переменную Twig и выбрасывает ее в [панели отладчика Grav](/08.advanced/03.debugging/index). Для просмотра значений на вкладке "Сообщения" отладчик должен быть **включен**.
