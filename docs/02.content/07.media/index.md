...
> Список поддерживаемых медиа-файлов в Grav CMS. Режимы отображения. Ссылки и лайтбоксы.
...
| data-srcset | В случае графических носителей это содержит строку `srcset`. ([Дополнительная информация](#Адаптивные-изображения))         |
...
<!-- tabs:start -->
<!-- tab:Векторное изображение -->
```markdown
![Sample Vector](sample-vector.svg?resize=300,300)
```
<img alt="Sample Vector" src="images/grav-logo.svg" width="300" height="300" />
<!-- tab:Анимированное изображение -->
```markdown
...
[Текстовый файл](https://learn.getgrav.org/17/content/media/acronyms.txt)
