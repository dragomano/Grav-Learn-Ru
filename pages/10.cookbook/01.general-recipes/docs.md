...
Изменения страницы теперь должны отображаться в вашем браузере. Если нет, убедитесь, что кэш страниц и кэш ветки отключены в настройках конфигурации системы Grav.
