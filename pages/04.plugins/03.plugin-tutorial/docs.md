...
Плагины также имеют возможность интеграции с командной строкой `bin/plugin` для выполнения задач. Вы можете следовать [расширенному руководству](/advanced/grav-cli-plugin), если хотите реализовать такую ​​функциональность.
