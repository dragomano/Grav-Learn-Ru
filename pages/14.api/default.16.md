...
> Объект GravCache используется в Grav для хранения и извлечения кэшированных данных. Он использует библиотеку DoctrineCache и поддерживает различные механизмы кэширования. К ним относятся: APCu RedisCache MemCache MemCacheD FileSystem

| Видимость | Функция |
|:-----------|:---------|
| public | <strong>__construct(</strong><em>[\Grav\Common\Grav](#class-gravcommongrav)</em> <strong>$grav</strong>)</strong> : <em>void</em><br /><em>Конструктор</em> |
| public static | <strong>clearCache(</strong><em>string</em> <strong>$remove=`'standard'`</strong>)</strong> : <em>array</em><br /><em>Вспомогательный метод для очистки всех кэшей Grav</em> |
| public static | <strong>clearJob(</strong><em>string</em> <strong>$type</strong>)</strong> : <em>void</em><br /><em>Статическая функция для вызова как запланированного задания для очистки кэша Grav</em> |
| public | <strong>contains(</strong><em>string</em> <strong>$id</strong>)</strong> : <em>bool true, если кэшированные элементы существуют</em><br /><em>Возвращает логическое состояние того, существует ли элемент в кэше, на основе ключа id</em> |
| public | <strong>delete(</strong><em>string</em> <strong>$id</strong>)</strong> : <em>bool true, если элемент был успешно удален</em><br /><em>Удаляет элемент из кэша на основе идентификатора</em> |
| public | <strong>deleteAll()</strong> : <em>bool</em><br /><em>Удаляет весь кэш</em> |
| public | <strong>fetch(</strong><em>string</em> <strong>$id</strong>)</strong> : <em>object/bool возвращает кэшированную запись, может быть любого типа или false, если не существует</em><br /><em>Получает кэшированную запись, если она существует на основе идентификатора. Если его не существует, возвращает false</em> |
| public | <strong>getCacheDriver()</strong> : <em>DoctrineCache\CacheProvider The cache driver to use</em><br /><em>Автоматически выбирает механизм кэширования для использования. Если вы выберете драйвер вручную, будет использоваться он. Если в конфигурации нет параметра конфигурации для $driver или для него установлено значение `auto`, он выберет лучший вариант в зависимости от того, какие расширения кэша установлены.</em> |
| public | <strong>getCacheStatus()</strong> : <em>string</em><br /><em>Получить состояние кэша</em> |
| public | <strong>getDriverName()</strong> : <em>mixed</em><br /><em>Возвращает текущее имя драйвера</em> |
| public | <strong>getDriverSetting()</strong> : <em>mixed</em><br /><em>Возвращает текущую настройку драйвера</em> |
| public | <strong>getEnabled()</strong> : <em>bool</em><br /><em>Возвращает текущее включенное состояние</em> |
| public | <strong>getKey()</strong> : <em>mixed</em><br /><em>Getter-метод для получения ключа кэша</em> |
| public | <strong>getLifetime()</strong> : <em>mixed</em><br /><em>Получение времени жизни кэша (в секундах)</em> |
| public | <strong>getSimpleCache()</strong> : <em>\Psr\SimpleCache\CacheInterface</em> |
| public | <strong>init(</strong><em>[\Grav\Common\Grav](#class-gravcommongrav)</em> <strong>$grav</strong>)</strong> : <em>void</em><br /><em>Инициализация, устанавливающая базовый ключ и драйвер на основе параметров конфигурации</em> |
| public static | <strong>invalidateCache()</strong> : <em>void</em> |
| public | <strong>isVolatileDriver(</strong><em>string</em> <strong>$setting</strong>)</strong> : <em>bool</em><br /><em>Определяет, является ли заданный драйвер энергозависимым (то есть находится ли он в памяти процесса PHP)</em> |
| public | <strong>onSchedulerInitialized(</strong><em>\RocketTheme\Toolbox\Event\Event</em> <strong>$event</strong>)</strong> : <em>void</em> |
| public static | <strong>purgeJob()</strong> : <em>void</em><br /><em>Статическая функция для вызова в качестве запланированного задания для очистки старых файлов Doctrine</em> |
| public | <strong>purgeOldCache()</strong> : <em>int</em><br /><em>Удаляет старые устаревшие файловые кэши</em> |
| public | <strong>save(</strong><em>string</em> <strong>$id</strong>, <em>array/object</em> <strong>$data</strong>, <em>int</em> <strong>$lifetime=null</strong>)</strong> : <em>void</em><br /><em>Сохраняет новую кэшированную запись.</em> |
| public | <strong>setEnabled(</strong><em>bool/int</em> <strong>$enabled</strong>)</strong> : <em>void</em><br /><em>Общедоступный метод доступа для установки включенного состояния кэша</em> |
| public | <strong>setKey(</strong><em>mixed</em> <strong>$key</strong>)</strong> : <em>void</em><br /><em>Setter-метод для установки ключа (дополнительно)</em> |
| public | <strong>setLifetime(</strong><em>int</em> <strong>$future</strong>)</strong> : <em>void</em><br /><em>Установить срок службы кэша программно</em> |
...
| Видимость | Функция |
|:-----------|:---------|
| public | <strong>__construct(</strong><em>string</em> <strong>$name</strong>, <em>[\Grav\Common\Grav](#class-gravcommongrav)</em> <strong>$grav</strong>, <em>[\Grav\Common\Config\Config](#class-gravcommonconfigconfig)</em> <strong>$config=null</strong>)</strong> : <em>void</em><br /><em>Конструктор.</em> |
| public | <strong>config()</strong> : <em>array</em><br /><em>Получить конфигурацию плагина.</em> |
| public | <strong>getBlueprint()</strong> : <em>[\Grav\Common\Data\Blueprint](#class-gravcommondatablueprint)</em><br /><em>Более простой метод получения для проекта плагина</em> |
| public static | <strong>getSubscribedEvents()</strong> : <em>array</em><br /><em>По умолчанию все методы назначаются слушателями с приоритетом по умолчанию..</em> |
| public | <strong>isAdmin()</strong> : <em>bool</em><br /><em>Определите, работает ли плагин под администратором</em> |
| public | <strong>isCli()</strong> : <em>bool</em><br /><em>Определите, работает ли плагин под CLI</em> |
| public | <strong>offsetExists(</strong><em>string</em> <strong>$offset</strong>)</strong> : <em>bool Возвращает TRUE в случае успеха или FALSE в случае неудачи..</em><br /><em>Есть ли смещение.</em> |
| public | <strong>offsetGet(</strong><em>string</em> <strong>$offset</strong>)</strong> : <em>mixed Может возвращать все типы значений.</em><br /><em>Возвращает значение по указанному смещению.</em> |
| public | <strong>offsetSet(</strong><em>string</em> <strong>$offset</strong>, <em>mixed</em> <strong>$value</strong>)</strong> : <em>void</em><br /><em>Присваивает значение указанному смещению.</em> |
| public | <strong>offsetUnset(</strong><em>string</em> <strong>$offset</strong>)</strong> : <em>void</em><br /><em>Сбрасывает смещение.</em> |
| public static | <strong>saveConfig(</strong><em>string</em> <strong>$plugin_name</strong>)</strong> : <em>bool</em><br /><em>Сохраняет на диске параметры плагина, которые в настоящее время хранятся в объекте Grav Config.</em> |
...
| protected | <strong>isPluginActiveAdmin(</strong><em>string</em> <strong>$plugin_route</strong>)</strong> : <em>bool</em><br /><em>Определите, активен ли этот маршрут в админке для плагина.</em> |
| protected | <strong>loadBlueprint()</strong> : <em>mixed</em><br /><em>Загрузить чертежи.</em> |
| protected | <strong>mergeConfig(</strong><em>[\Grav\Common\Page\Interfaces\PageInterface](#interface-gravcommonpageinterfacespageinterface)</em> <strong>$page</strong>, <em>bool/mixed</em> <strong>$deep=false</strong>, <em>array</em> <strong>$params=array()</strong>, <em>string</em> <strong>$type=`'plugins'`</strong>)</strong> : <em>[\Grav\Common\Data\Data](#class-gravcommondatadata)</em><br /><em>Объедините глобальную конфигурацию и конфигурацию страницы. настройки плагина. слить с настройками плагина.</em> |
| protected | <strong>parseLinks(</strong><em>string</em> <strong>$content</strong>, <em>callable</em> <strong>$function</strong>, <em>string</em> <strong>$internal_regex=`'(.*)'`</strong>)</strong> : <em>string</em><br /><em>Эта функция будет искать в строке ссылки Markdown в определенном формате. Значение ссылки может быть опционально сравнено с помощью $internal_regex и оперируется предоставленной функцией обратного вызова. Формат: [plugin:myplugin_name](function_data)</em> |

*Этот класс реализует \RocketTheme\Toolbox\Event\EventSubscriberInterface, \Symfony\Component\EventDispatcher\EventSubscriberInterface, \ArrayAccess*
...
| Видимость | Функция |
|:-----------|:---------|
| public | <strong>__construct(</strong><em>[\Grav\Common\Grav](#class-gravcommongrav)</em> <strong>$grav</strong>, <em>[\Grav\Common\Config\Config](#class-gravcommonconfigconfig)</em> <strong>$config</strong>, <em>string</em> <strong>$name</strong>)</strong> : <em>void</em><br /><em>Конструктор.</em> |
| public | <strong>config()</strong> : <em>[\Grav\Common\Config\Config](#class-gravcommonconfigconfig)</em><br /><em>Получить конфигурацию плагина.</em> |
| public | <strong>getBlueprint()</strong> : <em>mixed</em><br /><em>Более простой геттер для проекта темы</em> |
| public static | <strong>saveConfig(</strong><em>string</em> <strong>$theme_name</strong>)</strong> : <em>true</em><br /><em>Сохраняет на диске параметры темы, хранящиеся в данный момент в объекте Grav Config</em> |
| protected | <strong>loadBlueprint()</strong> : <em>mixed</em><br /><em>Загрузить чертежи.</em> |
| protected | <strong>mergeConfig(</strong><em>[\Grav\Common\Page\Interfaces\PageInterface](#interface-gravcommonpageinterfacespageinterface)</em> <strong>$page</strong>, <em>string</em> <strong>$deep=`'merge'`</strong>, <em>array</em> <strong>$params=array()</strong>, <em>string</em> <strong>$type=`'themes'`</strong>)</strong> : <em>void</em><br /><em>Переопределите метод mergeConfig для работы с темами</em> |
...
| Видимость | Функция |
|:-----------|:---------|
| public static | <strong>getComposerExecutor()</strong> : <em>string</em><br /><em>Вернуть путь к исполняемому файлу композитора</em> |
| public static | <strong>getComposerLocation()</strong> : <em>string</em><br /><em>Возвращает местонахождение композитора.</em> |
...
| Видимость | Функция |
|:-----------|:---------|
| public | <strong>__construct(</strong><em>string/array</em> <strong>$env=null</strong>)</strong> : <em>void</em><br /><em>Конструктор Uri.</em> |
| public | <strong>__toString()</strong> : <em>void</em> |
| public static | <strong>addNonce(</strong><em>string</em> <strong>$url</strong>, <em>string</em> <strong>$action</strong>, <em>string</em> <strong>$nonceParamName=`'nonce'`</strong>)</strong> : <em>строка URL с одноразовым номером</em><br /><em>Добавляет случайный код URL-адреса для определенного действия</em> |
| public | <strong>base()</strong> : <em>Базовый URI</em><br /><em>Вернуть базовый URI</em> |
| public | <strong>baseIncludingLanguage()</strong> : <em>Базовый URI</em><br /><em>Вернуть базовый относительный URL-адрес, включая языковой префикс или базовый относительный URL-адрес, если многоязычный не включен</em> |
| public | <strong>basename()</strong> : <em>Базовый URI</em><br /><em>Возвращает базовый URI</em> |
| public static | <strong>buildParams(</strong><em>array</em> <strong>$params</strong>)</strong> : <em>string</em> |
| public static | <strong>buildUrl(</strong><em>array</em> <strong>$parsed_url</strong>)</strong> : <em>string</em><br /><em>Противоположность встроенному PHP-методу parse_url()</em> |
| public static | <strong>cleanPath(</strong><em>string</em> <strong>$path</strong>)</strong> : <em>mixed/string</em><br /><em>Удаляет лишние двойные косые черты и исправляет обратные косые черты</em> |
| public static | <strong>convertUrl(</strong><em>[\Grav\Common\Page\Interfaces\PageInterface](#interface-gravcommonpageinterfacespageinterface)</em> <strong>$page</strong>, <em>string/array</em> <strong>$url</strong>, <em>string</em> <strong>$type=`'link'`</strong>, <em>bool</em> <strong>$absolute=false</strong>, <em>bool</em> <strong>$route_only=false</strong>)</strong> : <em>строка/массив более удобный форматированный URL</em><br /><em>Преобразует ссылки из абсолютного '/' или относительного (../..) в формат, удобный для Grav</em> |
| public static | <strong>convertUrlOld(</strong><em>[\Grav\Common\Page\Interfaces\PageInterface](#interface-gravcommonpageinterfacespageinterface)</em> <strong>$page</strong>, <em>string</em> <strong>$markdown_url</strong>, <em>string</em> <strong>$type=`'link'`</strong>, <em>null</em> <strong>$relative=null</strong>)</strong> : <em>строка более удобного отформатированного URL</em><br /><em>Преобразует ссылки из абсолютного '/' или относительного (../..) в формат, удобный для Grav</em> |
| public | <strong>currentPage()</strong> : <em>int</em><br /><em>Вернуть номер текущей страницы.</em> |
| public | <strong>environment()</strong> : <em>String</em><br /><em>Получает имя среды</em> |
| public | <strong>extension(</strong><em>string/null</em> <strong>$default=null</strong>)</strong> : <em>string Расширение URI</em><br /><em>Вернуть расширение URI</em> |
...
| public static | <strong>filterPath(</strong><em>string</em> <strong>$path</strong>)</strong> : <em>string The RFC 3986 percent-encoded uri path.</em><br /><em>Отфильтровать путь Uri. Этот метод процентно кодирует все зарезервированные символы в предоставленной строке пути. Этот метод НЕ будет дважды кодировать символы, которые уже закодированы в процентах..</em> |
| public static | <strong>filterQuery(</strong><em>string</em> <strong>$query</strong>)</strong> : <em>string Строка запроса, закодированная в процентах.</em><br /><em>Фильтрует строку запроса или фрагмент URI.</em> |
| public static | <strong>filterUserInfo(</strong><em>string</em> <strong>$info</strong>)</strong> : <em>string Закодированная в процентах строка пользователя или пароля.</em><br /><em>Фильтрует строку информации о пользователе.</em> |
| public | <strong>fragment(</strong><em>string</em> <strong>$fragment=null</strong>)</strong> : <em>string/null</em><br /><em>Получает фрагмент URI (например, #target)</em> |
| public | <strong>getContentType(</strong><em>bool</em> <strong>$short=true</strong>)</strong> : <em>null/string</em><br /><em>Получить тип контента из запроса</em> |
| public static | <strong>getCurrentRoute()</strong> : <em>[\Grav\Framework\Route\Route](#class-gravframeworkrouteroute)</em><br /><em>Возвращает текущий маршрут.</em> |
| public static | <strong>getCurrentUri()</strong> : <em>[\Grav\Framework\Uri\Uri](#class-gravframeworkuriuri)</em><br /><em>Возвращает текущий URI.</em> |
| public | <strong>host()</strong> : <em>string/null The host of the URI</em><br /><em>Вернуть хост URI</em> |
| public | <strong>init()</strong> : <em>void</em><br /><em>Инициализирует объект URI на основе URL-адреса, заданного для объекта</em> |
| public | <strong>initializeWithUrl(</strong><em>string</em> <strong>$url=`''`</strong>)</strong> : <em>\Grav\Common\$this</em><br /><em>Инициализируйте класс URI с URL-адресом, переданным через параметр. Используется для тестирования.</em> |
| public | <strong>initializeWithUrlAndRootPath(</strong><em>string</em> <strong>$url</strong>, <em>string</em> <strong>$root_path</strong>)</strong> : <em>\Grav\Common\$this</em><br /><em>Инициализируйте класс URI, указав аргументы url и root_path</em> |
| public static | <strong>ip()</strong> : <em>string ip address</em><br /><em>Вернуть IP-адрес текущего пользователя</em> |
| public static | <strong>isExternal(</strong><em>string</em> <strong>$url</strong>)</strong> : <em>boolean is eternal state</em><br /><em>Это внешний URL? если он начинается с http, тогда да, иначе false</em> |
...
*Этот класс наследует [\Grav\Common\Config\CompiledBase](#class-gravcommonconfigcompiledbase-abstract)*
...
### Класс: \Grav\Common\Config\CompiledBase (abstract)
...
### Класс: \Grav\Common\Page\Medium\Link
...
*Этот класс реализует [\Grav\Common\Page\Medium\RenderableInterface](#interface-gravcommonpagemediumrenderableinterface)*
...
### Класс: \Grav\Common\Processors\ConfigurationProcessor
...
### Класс: \Grav\Common\Processors\ErrorsProcessor
...
### Класс: \Grav\Common\Processors\DebuggerProcessor
...
### Класс: \Grav\Common\Processors\LoggerProcessor
...
### Класс: \Grav\Common\Twig\TwigExtension
...
*Этот класс наследует \Twig\Extension\AbstractExtension*

*Этот класс реализует \Twig\Extension\ExtensionInterface, \Twig\Extension\GlobalsInterface*
...
### Класс: \Grav\Common\User\FlexUser\User
...
*Этот класс наследует [\Grav\Framework\Flex\FlexObject](#class-gravframeworkflexflexobject)*
...
### Класс: \Grav\Common\User\FlexUser\UserCollection
...
*Этот класс наследует [\Grav\Framework\Flex\FlexIndex](#class-gravframeworkflexflexindex)*
...
### Класс: \Grav\Common\User\FlexUser\Storage\UserFolderStorage
...
### Класс: \Grav\Common\User\FlexUser\Storage\UserFileStorage
...
### Класс: \Grav\Framework\Flex\FlexIndex
...
*Этот класс наследует [\Grav\Framework\Object\ObjectIndex](#class-gravframeworkobjectobjectindex-abstract)*

*Этот класс реализует [\Grav\Framework\Object\Interfaces\NestedObjectInterface](#interface-gravframeworkobjectinterfacesnestedobjectinterface), \Doctrine\Common\Collections\Selectable, [\Grav\Framework\Object\Interfaces\ObjectInterface](#interface-gravframeworkobjectinterfacesobjectinterface), \Serializable, [\Grav\Framework\Object\Interfaces\ObjectCollectionInterface](#interface-gravframeworkobjectinterfacesobjectcollectioninterface), [\Grav\Framework\Collection\CollectionInterface](#interface-gravframeworkcollectioncollectioninterface), \JsonSerializable, \Countable, \IteratorAggregate, \Traversable, \ArrayAccess, \Doctrine\Common\Collections\Collection, [\Grav\Framework\Flex\Interfaces\FlexCollectionInterface](#interface-gravframeworkflexinterfacesflexcollectioninterface), [\Grav\Framework\Interfaces\RenderInterface](#interface-gravframeworkinterfacesrenderinterface), [\Grav\Framework\Flex\Interfaces\FlexCommonInterface](#interface-gravframeworkflexinterfacesflexcommoninterface), [\Grav\Framework\Flex\Interfaces\FlexIndexInterface](#interface-gravframeworkflexinterfacesflexindexinterface)*
...
### Класс: \Grav\Framework\Flex\FlexCollection
...
*Этот класс наследует [\Grav\Framework\Object\ObjectCollection](#class-gravframeworkobjectobjectcollection)*

*Этот класс реализует [\Grav\Framework\Object\Interfaces\NestedObjectInterface](#interface-gravframeworkobjectinterfacesnestedobjectinterface), [\Grav\Framework\Object\Interfaces\ObjectInterface](#interface-gravframeworkobjectinterfacesobjectinterface), \Serializable, [\Grav\Framework\Object\Interfaces\ObjectCollectionInterface](#interface-gravframeworkobjectinterfacesobjectcollectioninterface), \Doctrine\Common\Collections\Selectable, \Countable, \IteratorAggregate, \Traversable, \ArrayAccess, \Doctrine\Common\Collections\Collection, [\Grav\Framework\Collection\CollectionInterface](#interface-gravframeworkcollectioncollectioninterface), \JsonSerializable, [\Grav\Framework\Flex\Interfaces\FlexCollectionInterface](#interface-gravframeworkflexinterfacesflexcollectioninterface), [\Grav\Framework\Interfaces\RenderInterface](#interface-gravframeworkinterfacesrenderinterface), [\Grav\Framework\Flex\Interfaces\FlexCommonInterface](#interface-gravframeworkflexinterfacesflexcommoninterface)*

<hr /><a id="class-gravframeworkflexflexobject"></a>
### Класс: \Grav\Framework\Flex\FlexObject
