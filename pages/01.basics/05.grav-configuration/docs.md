...
!!! **СОВЕТ:** См. [Безопасность > Конфигурация](/security/configuration) для получения краткого руководства по обеспечению безопасности и оптимизации разрабатываемого сайта.
