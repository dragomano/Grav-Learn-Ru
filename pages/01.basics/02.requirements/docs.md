...
* MacOS 10.14 Mojave уже поставляется с веб-сервером Apache и PHP 7.1, ничего устанавливать не нужно!
...
* [MAMP for Windows](https://mamp.info) это давний фаворит Mac, но теперь он доступен и для Windows.
* [IIS with PHP](https://php.iis.net/) это быстрый способ запустить PHP на Windows.
* [AMPPS](https://www.ampps.com/downloads) это программный стек от Softaculous, позволяющий использовать Apache, PHP, Perl и Python. Это включает в себя всё, что вам нужно (и даже больше) для разработки Grav.
