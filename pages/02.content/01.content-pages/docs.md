...
![Страница-список](content-listing.png)
...
При этом будет использоваться текст над разделителем, на который ссылается `page.summary()` и полное содержание страницы, когда на нее ссылаются `page.content()`.
