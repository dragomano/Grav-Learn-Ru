...
Как мы уже описывали в разделе [Страница -> Папки](../content-pages#folders), **маршрутизация** в Grav в первую очередь контролируется структурой папок, которую вы используете при создании контента вашего сайта.
