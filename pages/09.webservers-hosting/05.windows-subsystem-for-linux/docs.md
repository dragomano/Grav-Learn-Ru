...
Если вы похожи на меня и у вас несколько веб-сайтов Grav, развернутых для отдельных проектов, вы можете прочитать документацию по [символическим ссылкам](/cli-console/command-line-intro?target=_blank#symbolic-links) и о [копировании проекта](/cli-console/grav-cli?target=_blank#copying-a-project) для создания символьной копии одного ядра Grav.